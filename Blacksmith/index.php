...
<html lang="pt-br">
  <head>
    ...
    <meta name="keywords" content="Forja,Blacksmitch,Organizador de torneios,Chaves de torneio,RP,Cristal">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25">Blacksmitch</div>
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="Login.php" class="nav-link"><span>Fazer Login</span></a></li>
              </ul>
            </nav>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">Iniciativa Blacksmitch</h1>
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">A iniciativa é uma plataforma onde o você pode criar, compartilhar e realizar competições sem esquentar muito a cabeça.</p>
                  <p data-aos="fade-up" data-aos-delay="300"><a href="More.html" class="btn btn-primary py-3 px-5 btn-pill">Ver mais</a></p>

                </div>

                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="" method="post" class="form-box">
                    <h3 class="h4 text-black mb-4">Cadastre-se</h3>
